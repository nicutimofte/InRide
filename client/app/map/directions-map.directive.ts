...
export class DirectionsMapDirective {
    ...
    updateDirections(){
        this.gmapsApi.getNativeMap().then(map => {
            ...
            //requestDirections('(46.7700713, 23.590370300000018)', '(46.7695434,23.7131124)');
           //end
    ...
    private requestDirections(start, end,directionsService,map) {
        directionsService.route({
            origin: start,
            destination: end,
            travelMode: google.maps.DirectionsTravelMode.DRIVING
        }, function (result) {
            this.renderDirections(result,map);
        });
    }
